...
public class WUGTest {
	...
	private static int vertexTest(Object[] vertArray) {
		...
		if (wuVertArray == null) {
			...
			getDeduction = 1;
		} else if (((wuVertArray[0] != vertArray[0]) || (wuVertArray[1] != vertArray[1]))
				&& ((wuVertArray[0] != vertArray[1]) || (wuVertArray[1] != vertArray[0]))) {
			System.out.println("getVertices() returns array containing"
					+ " wrong objects.");
			getDeduction = 1;
		}
		...
		if (wuVertArray == null) {
			...
			getDeduction = 1;
				...
				&& (wuVertArray[0] != vertArray[2]) && (wuVertArray[0] != vertArray[4]))
				|| ((wuVertArray[1] != vertArray[1])
						&& (wuVertArray[1] != vertArray[2]) && (wuVertArray[1] != vertArray[4]))
				|| ((wuVertArray[2] != vertArray[1])
						&& (wuVertArray[2] != vertArray[2]) && (wuVertArray[2] != vertArray[4]))) {
			System.out.println("getVertices() returns array containing "
					+ "wrong objects.");
			getDeduction = 1;
	...
	private static int edgeTest(Object[] vertArray) {
		...
		if (g.isEdge(vertArray[3], vertArray[7])) {
			System.out
					.println("isEdge(vertex 3, vertex 7) should return false "
							+ " but returns true.");
			isDeduction = 1;
		}
		...
		if (g.isEdge(vertArray[3], vertArray[3])) {
			System.out
					.println("isEdge(vertex 3, vertex 3) should return false "
							+ " but returns true.");
			isDeduction = 1;
		}
		...
		if (neigh == null) {
			System.out
					.println("getNeighbors(vertex 3) improperly returns null.");
			getDeduction = 1;
			...
			System.out.println("getNeighbors(vertex 3) returns weightList of"
					...
					+ "; should have length 2.");
			getDeduction = 1;
		} else if (((neigh.neighborList[0] != vertArray[3]) || (neigh.neighborList[1] != vertArray[7]))
				&& ((neigh.neighborList[0] != vertArray[7]) || (neigh.neighborList[1] != vertArray[3]))) {
			System.out
					.println("getNeighbors(vertex 3) returns array containing"
							+ " wrong objects.");
			getDeduction = 1;
		...
		if (g.isEdge(vertArray[1], vertArray[6])) {
			System.out
					.println("isEdge(vertex 1, vertex 6) should return false "
							+ " but returns true.");
			remEDeduction = 1;
		}
		if (g.isEdge(vertArray[6], vertArray[1])) {
			System.out
					.println("isEdge(vertex 6, vertex 1) should return false "
							+ " but returns true.");
			remEDeduction = 1;
		}
		...
		if (g.isEdge(vertArray[7], vertArray[3])) {
			System.out
					.println("isEdge(vertex 7, vertex 3) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[3], vertArray[9])) {
			System.out
					.println("isEdge(vertex 3, vertex 9) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[9], vertArray[3])) {
			System.out
					.println("isEdge(vertex 9, vertex 3) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[3], vertArray[1])) {
			System.out
					.println("isEdge(vertex 3, vertex 1) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[1], vertArray[3])) {
			System.out
					.println("isEdge(vertex 1, vertex 3) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		result = g.degree(vertArray[1]);
		...
		if (neigh == null) {
			System.out
					.println("getNeighbors(vertex 7) improperly returns null.");
			getDeduction = 1;
		} else if (neigh.neighborList == null) {
			...
			System.out
					.println("getNeighbors(vertex 7) returns array containing"
							+ " wrong object.");
			getDeduction = 1;
		...
		if (g.isEdge(vertArray[1], vertArray[1])) {
			System.out
					.println("isEdge(vertex 1, vertex 1) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		result = g.degree(vertArray[1]);
		...
		if (g.isEdge(vertArray[9], vertArray[7])) {
			System.out
					.println("isEdge(vertex 9, vertex 7) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[7], vertArray[9])) {
			System.out
					.println("isEdge(vertex 7, vertex 9) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		...
		if (g.isEdge(vertArray[9], vertArray[0])) {
			System.out
					.println("isEdge(vertex 9, vertex 0) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		if (g.isEdge(vertArray[0], vertArray[9])) {
			System.out
					.println("isEdge(vertex 0, vertex 9) should return false "
							+ " but returns true.");
			remVDeduction = 1;
		}
		result = g.degree(vertArray[9]);
		...
		return countDeduction + degreeDeduction + 2 * getDeduction
				+ isDeduction + weightDeduction + 2 * remEDeduction + 2
				* remVDeduction;
	...
	public static void main(String[] args) {
		...
		System.out.println("Your WUGraph test score is "
				+ (0.5 * (double) score) + " out of 7.0.");
