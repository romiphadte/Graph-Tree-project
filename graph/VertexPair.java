...
/**
 * The VertexPair represents a pair of objects that act as vertices in a WUGraph
 * (weighted, undirected graph). The purpose of a VertexPair is to act as a key
 * for Java's hashCode() and equals() functions. It is designed so that the
 * order of the two objects is immaterial; (u, v) is the same as (v, u).
 */
